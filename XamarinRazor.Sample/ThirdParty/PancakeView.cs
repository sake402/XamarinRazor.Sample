...
{
    public partial class PancakeView : ComponentToXamarinLayoutBridge<Xamarin.Forms.PancakeView.PancakeView, PancakeView>
    {
        public PancakeView()
        {
        }
        public PancakeView(Xamarin.Forms.PancakeView.PancakeView _element):base(_element)
        {
        }
		...
		[Parameter] public System.Int32 Sides { set => P.Sides = value; get => P.Sides; }
		[Parameter] public Xamarin.Forms.Binding BindSides { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.SidesProperty, value); } }
		[Parameter] public System.Double OffsetAngle { set => P.OffsetAngle = value; get => P.OffsetAngle; }
		[Parameter] public Xamarin.Forms.Binding BindOffsetAngle { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.OffsetAngleProperty, value); } }
		[Parameter] public Xamarin.Forms.PancakeView.GradientStopCollection BackgroundGradientStops { set => P.BackgroundGradientStops = value; get => P.BackgroundGradientStops; }
		[Parameter] public Xamarin.Forms.Binding BindBackgroundGradientStops { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.BackgroundGradientStopsProperty, value); } }
		[Parameter] public Xamarin.Forms.CornerRadius CornerRadius { set => P.CornerRadius = value; get => P.CornerRadius; }
		[Parameter] public Xamarin.Forms.Binding BindCornerRadius { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.CornerRadiusProperty, value); } }
		[Parameter] public Xamarin.Forms.PancakeView.DropShadow Shadow { set => P.Shadow = value; get => P.Shadow; }
		[Parameter] public Xamarin.Forms.Binding BindShadow { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.ShadowProperty, value); } }
		[Parameter] public Xamarin.Forms.PancakeView.Border Border { set => P.Border = value; get => P.Border; }
		[Parameter] public Xamarin.Forms.Binding BindBorder { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.BorderProperty, value); } }
		[Parameter] public Xamarin.Forms.Point BackgroundGradientStartPoint { set => P.BackgroundGradientStartPoint = value; get => P.BackgroundGradientStartPoint; }
		[Parameter] public Xamarin.Forms.Binding BindBackgroundGradientStartPoint { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.BackgroundGradientStartPointProperty, value); } }
		[Parameter] public Xamarin.Forms.Point BackgroundGradientEndPoint { set => P.BackgroundGradientEndPoint = value; get => P.BackgroundGradientEndPoint; }
		[Parameter] public Xamarin.Forms.Binding BindBackgroundGradientEndPoint { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.BackgroundGradientEndPointProperty, value); } }
		[Parameter] public Xamarin.Forms.View Content { set => P.Content = value; get => P.Content; }
		[Parameter] public Xamarin.Forms.Binding BindContent { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.ContentProperty, value); } }
		[Parameter] public Xamarin.Forms.ControlTemplate ControlTemplate { set => P.ControlTemplate = value; get => P.ControlTemplate; }
		[Parameter] public Xamarin.Forms.Binding BindControlTemplate { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.ControlTemplateProperty, value); } }
		[Parameter] public System.Boolean IsClippedToBounds { set => P.IsClippedToBounds = value; get => P.IsClippedToBounds; }
		[Parameter] public Xamarin.Forms.Binding BindIsClippedToBounds { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.IsClippedToBoundsProperty, value); } }
		[Parameter] public Xamarin.Forms.Thickness Padding { set => P.Padding = value; get => P.Padding; }
		[Parameter] public Xamarin.Forms.Binding BindPadding { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.PaddingProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindCascadeInputTransparent { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.CascadeInputTransparentProperty, value); } }
		[Parameter] public Xamarin.Forms.LayoutOptions HorizontalOptions { set => P.HorizontalOptions = value; get => P.HorizontalOptions; }
		[Parameter] public Xamarin.Forms.Binding BindHorizontalOptions { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.HorizontalOptionsProperty, value); } }
		[Parameter] public Xamarin.Forms.Thickness Margin { set => P.Margin = value; get => P.Margin; }
		[Parameter] public Xamarin.Forms.Binding BindMargin { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.MarginProperty, value); } }
		[Parameter] public Xamarin.Forms.LayoutOptions VerticalOptions { set => P.VerticalOptions = value; get => P.VerticalOptions; }
		[Parameter] public Xamarin.Forms.Binding BindVerticalOptions { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.VerticalOptionsProperty, value); } }
		[Parameter] public Xamarin.Forms.IVisual Visual { set => P.Visual = value; get => P.Visual; }
		[Parameter] public Xamarin.Forms.Binding BindVisual { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.VisualProperty, value); } }
		[Parameter] public Xamarin.Forms.FlowDirection FlowDirection { set => P.FlowDirection = value; get => P.FlowDirection; }
		[Parameter] public Xamarin.Forms.Binding BindFlowDirection { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.FlowDirectionProperty, value); } }
		[Parameter] public System.Double AnchorX { set => P.AnchorX = value; get => P.AnchorX; }
		[Parameter] public Xamarin.Forms.Binding BindAnchorX { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.AnchorXProperty, value); } }
		[Parameter] public System.Double AnchorY { set => P.AnchorY = value; get => P.AnchorY; }
		[Parameter] public Xamarin.Forms.Binding BindAnchorY { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.AnchorYProperty, value); } }
		[Parameter] public Xamarin.Forms.Color BackgroundColor { set => P.BackgroundColor = value; get => P.BackgroundColor; }
		[Parameter] public Xamarin.Forms.Binding BindBackgroundColor { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.BackgroundColorProperty, value); } }
		[Parameter] public System.Double HeightRequest { set => P.HeightRequest = value; get => P.HeightRequest; }
		[Parameter] public Xamarin.Forms.Binding BindHeightRequest { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.HeightRequestProperty, value); } }
		[Parameter] public System.Boolean InputTransparent { set => P.InputTransparent = value; get => P.InputTransparent; }
		[Parameter] public Xamarin.Forms.Binding BindInputTransparent { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.InputTransparentProperty, value); } }
		[Parameter] public System.Boolean IsEnabled { set => P.IsEnabled = value; get => P.IsEnabled; }
		[Parameter] public Xamarin.Forms.Binding BindIsEnabled { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.IsEnabledProperty, value); } }
		[Parameter] public System.Boolean IsVisible { set => P.IsVisible = value; get => P.IsVisible; }
		[Parameter] public Xamarin.Forms.Binding BindIsVisible { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.IsVisibleProperty, value); } }
		[Parameter] public System.Double MinimumHeightRequest { set => P.MinimumHeightRequest = value; get => P.MinimumHeightRequest; }
		[Parameter] public Xamarin.Forms.Binding BindMinimumHeightRequest { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.MinimumHeightRequestProperty, value); } }
		[Parameter] public System.Double MinimumWidthRequest { set => P.MinimumWidthRequest = value; get => P.MinimumWidthRequest; }
		[Parameter] public Xamarin.Forms.Binding BindMinimumWidthRequest { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.MinimumWidthRequestProperty, value); } }
		[Parameter] public System.Double Opacity { set => P.Opacity = value; get => P.Opacity; }
		[Parameter] public Xamarin.Forms.Binding BindOpacity { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.OpacityProperty, value); } }
		[Parameter] public System.Double Rotation { set => P.Rotation = value; get => P.Rotation; }
		[Parameter] public Xamarin.Forms.Binding BindRotation { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.RotationProperty, value); } }
		[Parameter] public System.Double RotationX { set => P.RotationX = value; get => P.RotationX; }
		[Parameter] public Xamarin.Forms.Binding BindRotationX { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.RotationXProperty, value); } }
		[Parameter] public System.Double RotationY { set => P.RotationY = value; get => P.RotationY; }
		[Parameter] public Xamarin.Forms.Binding BindRotationY { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.RotationYProperty, value); } }
		[Parameter] public System.Double Scale { set => P.Scale = value; get => P.Scale; }
		[Parameter] public Xamarin.Forms.Binding BindScale { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.ScaleProperty, value); } }
		[Parameter] public System.Double ScaleX { set => P.ScaleX = value; get => P.ScaleX; }
		[Parameter] public Xamarin.Forms.Binding BindScaleX { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.ScaleXProperty, value); } }
		[Parameter] public System.Double ScaleY { set => P.ScaleY = value; get => P.ScaleY; }
		[Parameter] public Xamarin.Forms.Binding BindScaleY { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.ScaleYProperty, value); } }
		[Parameter] public System.Int32 TabIndex { set => P.TabIndex = value; get => P.TabIndex; }
		[Parameter] public Xamarin.Forms.Binding BindTabIndex { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.TabIndexProperty, value); } }
		[Parameter] public System.Boolean IsTabStop { set => P.IsTabStop = value; get => P.IsTabStop; }
		[Parameter] public Xamarin.Forms.Binding BindIsTabStop { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.IsTabStopProperty, value); } }
		[Parameter] public System.Double TranslationX { set => P.TranslationX = value; get => P.TranslationX; }
		[Parameter] public Xamarin.Forms.Binding BindTranslationX { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.TranslationXProperty, value); } }
		[Parameter] public System.Double TranslationY { set => P.TranslationY = value; get => P.TranslationY; }
		[Parameter] public Xamarin.Forms.Binding BindTranslationY { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.TranslationYProperty, value); } }
		[Parameter] public System.Double WidthRequest { set => P.WidthRequest = value; get => P.WidthRequest; }
		[Parameter] public Xamarin.Forms.Binding BindWidthRequest { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.WidthRequestProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindStyle { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.StyleProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindAutomationId { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.AutomationIdProperty, value); } }
		[Parameter] public System.String ClassId { set => P.ClassId = value; get => P.ClassId; }
		[Parameter] public Xamarin.Forms.Binding BindClassId { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.ClassIdProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindBindingContext { set { P.SetBinding(Xamarin.Forms.PancakeView.PancakeView.BindingContextProperty, value); } }
    }
}
