...
{
    public partial class RGBSliders : ComponentToXamarinBridge<ColorPicker.RGBSliders, RGBSliders>
    {
        public RGBSliders()
        {
        }
        public RGBSliders(ColorPicker.RGBSliders _element):base(_element)
        {
        }
		...
		[Parameter] public Xamarin.Forms.Binding BindShowAlphaSlider { set { P.SetBinding(ColorPicker.RGBSliders.ShowAlphaSliderProperty, value); } }
		[Parameter] public System.Nullable<System.Single> PickerRadius { set => P.PickerRadius = value; get => P.PickerRadius; }
		[Parameter] public Xamarin.Forms.Binding BindPickerRadius { set { P.SetBinding(ColorPicker.RGBSliders.PickerRadiusProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindConnectedColorPicker { set { P.SetBinding(ColorPicker.RGBSliders.ConnectedColorPickerProperty, value); } }
		[Parameter] public Xamarin.Forms.Color SelectedColor { set => P.SelectedColor = value; get => P.SelectedColor; }
		[Parameter] public Xamarin.Forms.Binding BindSelectedColor { set { P.SetBinding(ColorPicker.RGBSliders.SelectedColorProperty, value); } }
		[Parameter] public Xamarin.Forms.View Content { set => P.Content = value; get => P.Content; }
		[Parameter] public Xamarin.Forms.Binding BindContent { set { P.SetBinding(ColorPicker.RGBSliders.ContentProperty, value); } }
		[Parameter] public Xamarin.Forms.ControlTemplate ControlTemplate { set => P.ControlTemplate = value; get => P.ControlTemplate; }
		[Parameter] public Xamarin.Forms.Binding BindControlTemplate { set { P.SetBinding(ColorPicker.RGBSliders.ControlTemplateProperty, value); } }
		[Parameter] public System.Boolean IsClippedToBounds { set => P.IsClippedToBounds = value; get => P.IsClippedToBounds; }
		[Parameter] public Xamarin.Forms.Binding BindIsClippedToBounds { set { P.SetBinding(ColorPicker.RGBSliders.IsClippedToBoundsProperty, value); } }
		[Parameter] public Xamarin.Forms.Thickness Padding { set => P.Padding = value; get => P.Padding; }
		[Parameter] public Xamarin.Forms.Binding BindPadding { set { P.SetBinding(ColorPicker.RGBSliders.PaddingProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindCascadeInputTransparent { set { P.SetBinding(ColorPicker.RGBSliders.CascadeInputTransparentProperty, value); } }
		[Parameter] public Xamarin.Forms.LayoutOptions HorizontalOptions { set => P.HorizontalOptions = value; get => P.HorizontalOptions; }
		[Parameter] public Xamarin.Forms.Binding BindHorizontalOptions { set { P.SetBinding(ColorPicker.RGBSliders.HorizontalOptionsProperty, value); } }
		[Parameter] public Xamarin.Forms.Thickness Margin { set => P.Margin = value; get => P.Margin; }
		[Parameter] public Xamarin.Forms.Binding BindMargin { set { P.SetBinding(ColorPicker.RGBSliders.MarginProperty, value); } }
		[Parameter] public Xamarin.Forms.LayoutOptions VerticalOptions { set => P.VerticalOptions = value; get => P.VerticalOptions; }
		[Parameter] public Xamarin.Forms.Binding BindVerticalOptions { set { P.SetBinding(ColorPicker.RGBSliders.VerticalOptionsProperty, value); } }
		[Parameter] public Xamarin.Forms.IVisual Visual { set => P.Visual = value; get => P.Visual; }
		[Parameter] public Xamarin.Forms.Binding BindVisual { set { P.SetBinding(ColorPicker.RGBSliders.VisualProperty, value); } }
		[Parameter] public Xamarin.Forms.FlowDirection FlowDirection { set => P.FlowDirection = value; get => P.FlowDirection; }
		[Parameter] public Xamarin.Forms.Binding BindFlowDirection { set { P.SetBinding(ColorPicker.RGBSliders.FlowDirectionProperty, value); } }
		[Parameter] public System.Double AnchorX { set => P.AnchorX = value; get => P.AnchorX; }
		[Parameter] public Xamarin.Forms.Binding BindAnchorX { set { P.SetBinding(ColorPicker.RGBSliders.AnchorXProperty, value); } }
		[Parameter] public System.Double AnchorY { set => P.AnchorY = value; get => P.AnchorY; }
		[Parameter] public Xamarin.Forms.Binding BindAnchorY { set { P.SetBinding(ColorPicker.RGBSliders.AnchorYProperty, value); } }
		[Parameter] public Xamarin.Forms.Color BackgroundColor { set => P.BackgroundColor = value; get => P.BackgroundColor; }
		[Parameter] public Xamarin.Forms.Binding BindBackgroundColor { set { P.SetBinding(ColorPicker.RGBSliders.BackgroundColorProperty, value); } }
		[Parameter] public System.Double HeightRequest { set => P.HeightRequest = value; get => P.HeightRequest; }
		[Parameter] public Xamarin.Forms.Binding BindHeightRequest { set { P.SetBinding(ColorPicker.RGBSliders.HeightRequestProperty, value); } }
		[Parameter] public System.Boolean InputTransparent { set => P.InputTransparent = value; get => P.InputTransparent; }
		[Parameter] public Xamarin.Forms.Binding BindInputTransparent { set { P.SetBinding(ColorPicker.RGBSliders.InputTransparentProperty, value); } }
		[Parameter] public System.Boolean IsEnabled { set => P.IsEnabled = value; get => P.IsEnabled; }
		[Parameter] public Xamarin.Forms.Binding BindIsEnabled { set { P.SetBinding(ColorPicker.RGBSliders.IsEnabledProperty, value); } }
		[Parameter] public System.Boolean IsVisible { set => P.IsVisible = value; get => P.IsVisible; }
		[Parameter] public Xamarin.Forms.Binding BindIsVisible { set { P.SetBinding(ColorPicker.RGBSliders.IsVisibleProperty, value); } }
		[Parameter] public System.Double MinimumHeightRequest { set => P.MinimumHeightRequest = value; get => P.MinimumHeightRequest; }
		[Parameter] public Xamarin.Forms.Binding BindMinimumHeightRequest { set { P.SetBinding(ColorPicker.RGBSliders.MinimumHeightRequestProperty, value); } }
		[Parameter] public System.Double MinimumWidthRequest { set => P.MinimumWidthRequest = value; get => P.MinimumWidthRequest; }
		[Parameter] public Xamarin.Forms.Binding BindMinimumWidthRequest { set { P.SetBinding(ColorPicker.RGBSliders.MinimumWidthRequestProperty, value); } }
		[Parameter] public System.Double Opacity { set => P.Opacity = value; get => P.Opacity; }
		[Parameter] public Xamarin.Forms.Binding BindOpacity { set { P.SetBinding(ColorPicker.RGBSliders.OpacityProperty, value); } }
		[Parameter] public System.Double Rotation { set => P.Rotation = value; get => P.Rotation; }
		[Parameter] public Xamarin.Forms.Binding BindRotation { set { P.SetBinding(ColorPicker.RGBSliders.RotationProperty, value); } }
		[Parameter] public System.Double RotationX { set => P.RotationX = value; get => P.RotationX; }
		[Parameter] public Xamarin.Forms.Binding BindRotationX { set { P.SetBinding(ColorPicker.RGBSliders.RotationXProperty, value); } }
		[Parameter] public System.Double RotationY { set => P.RotationY = value; get => P.RotationY; }
		[Parameter] public Xamarin.Forms.Binding BindRotationY { set { P.SetBinding(ColorPicker.RGBSliders.RotationYProperty, value); } }
		[Parameter] public System.Double Scale { set => P.Scale = value; get => P.Scale; }
		[Parameter] public Xamarin.Forms.Binding BindScale { set { P.SetBinding(ColorPicker.RGBSliders.ScaleProperty, value); } }
		[Parameter] public System.Double ScaleX { set => P.ScaleX = value; get => P.ScaleX; }
		[Parameter] public Xamarin.Forms.Binding BindScaleX { set { P.SetBinding(ColorPicker.RGBSliders.ScaleXProperty, value); } }
		[Parameter] public System.Double ScaleY { set => P.ScaleY = value; get => P.ScaleY; }
		[Parameter] public Xamarin.Forms.Binding BindScaleY { set { P.SetBinding(ColorPicker.RGBSliders.ScaleYProperty, value); } }
		[Parameter] public System.Int32 TabIndex { set => P.TabIndex = value; get => P.TabIndex; }
		[Parameter] public Xamarin.Forms.Binding BindTabIndex { set { P.SetBinding(ColorPicker.RGBSliders.TabIndexProperty, value); } }
		[Parameter] public System.Boolean IsTabStop { set => P.IsTabStop = value; get => P.IsTabStop; }
		[Parameter] public Xamarin.Forms.Binding BindIsTabStop { set { P.SetBinding(ColorPicker.RGBSliders.IsTabStopProperty, value); } }
		[Parameter] public System.Double TranslationX { set => P.TranslationX = value; get => P.TranslationX; }
		[Parameter] public Xamarin.Forms.Binding BindTranslationX { set { P.SetBinding(ColorPicker.RGBSliders.TranslationXProperty, value); } }
		[Parameter] public System.Double TranslationY { set => P.TranslationY = value; get => P.TranslationY; }
		[Parameter] public Xamarin.Forms.Binding BindTranslationY { set { P.SetBinding(ColorPicker.RGBSliders.TranslationYProperty, value); } }
		[Parameter] public System.Double WidthRequest { set => P.WidthRequest = value; get => P.WidthRequest; }
		[Parameter] public Xamarin.Forms.Binding BindWidthRequest { set { P.SetBinding(ColorPicker.RGBSliders.WidthRequestProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindStyle { set { P.SetBinding(ColorPicker.RGBSliders.StyleProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindAutomationId { set { P.SetBinding(ColorPicker.RGBSliders.AutomationIdProperty, value); } }
		[Parameter] public System.String ClassId { set => P.ClassId = value; get => P.ClassId; }
		[Parameter] public Xamarin.Forms.Binding BindClassId { set { P.SetBinding(ColorPicker.RGBSliders.ClassIdProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindBindingContext { set { P.SetBinding(ColorPicker.RGBSliders.BindingContextProperty, value); } }
    }
}
