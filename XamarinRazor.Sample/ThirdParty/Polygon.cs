...
{
    public partial class Polygon : ComponentToXamarinBridge<Xamarin.Forms.Maps.Polygon, Polygon>
    {
        public Polygon()
        {
        }
        public Polygon(Xamarin.Forms.Maps.Polygon _element):base(_element)
        {
        }
		...
		[Parameter] public Xamarin.Forms.Binding BindFillColor { set { P.SetBinding(Xamarin.Forms.Maps.Polygon.FillColorProperty, value); } }
